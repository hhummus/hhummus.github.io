...
const router = createBrowserRouter( 
  ...
  <Route element={<RootLayout />} errorElement={<ErrorPage />}>
    ...
    <Route path="tidligere-arbeid" element={<PortfolioLayout />}>
      <Route index element={<Portfolio />} />
      <Route path="kok" element={ <Kok />}></Route>
      <Route path="new-movements" element={ <NewMovements />}></Route>
      <Route path="ambijus" element={ <Ambijus />}></Route>
      <Route path="cliff-cabin" element={ <CliffCabin />}></Route>
      <Route path="vinbaren-pa-molla" element={ <Vinbaren />}></Route>
      <Route path="torungen-design" element={ <Torungen />}></Route>
      <Route path="wilder-kitchen" element={ <WilderKitchen/>}></Route>
      <Route path="bergill" element={ <Bergill />}></Route>
      <Route path="sovesveis" element={ <Sovesveis />}></Route>
    </Route>
